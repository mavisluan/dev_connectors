...
// @desc Get current uesrs profile
// @access private
// whenever we use a private route, use middleware to authenticate it first
...
router.post(
    ...
    async (req, res) => {
        ...
        // turn skills string into array and trim space
        if (skills) {
...
router.delete('/education/:eduId', auth, async (req, res) => {
    try {
        const profile = await Profile.findOne({ user: req.user.id });
        profile.education.id(req.params.eduId).remove();
